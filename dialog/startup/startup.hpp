...
class text_information: RscText
{
	...
	text = "Before generating the campaign with non-default parameters, make sure the map you are playing on is able to host all the zones. Otherwise DUWS may not be able to generate the zones."; //--- ToDo: Localize;
