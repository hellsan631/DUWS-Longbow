...
switch (_index) do
{
	...
	case index_amount_cp_250:
    {
    commandpointsblu1 = 250
    };
    ...
    case index_amount_cp_150:
    {
    commandpointsblu1 = 150
    };
    ...
    case index_amount_cp_75:
    {
    commandpointsblu1 = 75
    };
...
case index_blufor_ap_250:
    {
    blufor_ap = 250;
    };

case index_blufor_ap_300:
    {
    blufor_ap = 300;
    };
...
switch (_index) do
{
	...
	case index_opfor_ap_250:
    {
    opfor_ap = 250;
    };

	case index_opfor_ap_300:
    {
    opfor_ap = 300;
    };
...
switch (_index) do {
    ...
    case index_cp_reward_multiplier_three:{
        cp_reward_multiplier = 3;
    };
    case index_cp_reward_multiplier_four:{
        cp_reward_multiplier = 4;
    };
