...
{
	idc = 1800;
	text = "Select how the HQ is placed on the map."; //--- ToDo: Localize;
...
class hq_placement_random_button: RscButton
{
	...
	w = 18 * GUI_GRID_W;
	h = 2.5 * GUI_GRID_H;
	tooltip = "The HQ is randomly placed on the map."; //--- ToDo: Localize;
...
class hq_placement_manual_button: RscButton
{
	...
	w = 18 * GUI_GRID_W;
	h = 2.5 * GUI_GRID_H;
	tooltip = "You choose where the HQ is placed on the map."; //--- ToDo: Localize;
