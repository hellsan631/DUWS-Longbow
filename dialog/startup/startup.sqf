  ...
  index_min_radius_250 = lbAdd [2101, "250 meters"];
...
index_cp_reward_multiplier_three = lbAdd [2133, "3"];
index_cp_reward_multiplier_four = lbAdd [2133, "4"];
