diag_log format ["------------------ DUWS Unofficial START ----v1.20 based on Modified ------ player: %1", profileName];
//////////////////////////////////////////////////////
...
// --------------------------------------------------------------------------------------------------------------
	...
	if (support_armory_available) then {hq_blu1 addaction ["<t color='#ffffff'>Armory 1 (VAS)</t>","VAS\open.sqf", "", 18, true, true, "", "_this == player"];};
	if (support_armory_available) then {hq_blu1 addaction ["<t color='#ffffff'>Armory 2 (VA)</t>","va.sqf", "", 17, true, true, "", "_this == player"];};
	if (support_halo_available) then {hq_blu1 addAction ["<t color='#ffffff'>HALO Solo (5CP)</t>", "ATM_airdrop\atm_airdrop.sqf", "", 14, true, true, "", "_this == player"];};
	if (support_halo_available) then {hq_blu1 addAction ["<t color='#ffffff'>HALO Group (5CP)</t>", "COB_HALO\grphalo.sqf", "", 13, true, true, "", "_this == player"];};

	if (support_armory_available) then {_x addaction ["<t color='#ffffff'>Armory 1 (VAS)</t>","VAS\open.sqf", "", 18, true, true, "", "_this == player"]} forEach (Array_of_FOBS);
	if (support_armory_available) then {_x addaction ["<t color='#ffffff'>Armory 2 (VA)</t>","va.sqf", "", 17, true, true, "", "_this == player"]} forEach (Array_of_FOBS);
	if (support_halo_available) then {_x addaction ["<t color='#ffffff'>HALO Solo (5CP)</t>", "ATM_airdrop\atm_airdrop.sqf", "", 14, true, true, "", "_this == player"]} forEach (Array_of_FOBS);
    if (support_halo_available) then {_x addaction ["<t color='#ffffff'>HALO Group (5CP)</t>", "COB_HALO\grphalo.sqf", "", 13, true, true, "", "_this == player"]} forEach (Array_of_FOBS);
