...
class PXS_RscSatellite
{
	...
	class Controls
	{
		...
		{
			x = safezoneXAbs + 0.055 * safezoneW;
...
/*		//frame (Grindlines and frame disabled because I prefer no lines -Emton)
