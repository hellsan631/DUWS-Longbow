// pFLIRenable = player addaction ["<t color='#ffffff'>Activate FLIR</t>","pflir\livefeed.sqf","", 0,false,true,"","_target == _this"];
...
pFLIRdisable = player addaction ["<t color='#ffffff'>Deactivate FLIR</t>","pflir\livefeedexit.sqf","", 0,false,true,"","_target == _this"];
