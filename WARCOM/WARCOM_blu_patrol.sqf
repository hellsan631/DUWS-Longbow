...
[] spawn {
	...
	waitUntil {sleep 1;WARCOM_blufor_ap>35};          
	WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "BLU_F" >> "Infantry" >> "BUS_InfSquad");

	waitUntil {sleep 1;WARCOM_blufor_ap>60};          
	WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "BLU_F" >> "Infantry" >> "BUS_InfSquad_Weapons");

	waitUntil {sleep 1;WARCOM_blufor_ap>85};          
	WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "BLU_F" >> "Mechanized" >> "BUS_MechInfSquad");

	waitUntil {sleep 1;WARCOM_blufor_ap>110};          
	WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "BLU_F" >> "Mechanized" >> "BUS_MechInf_AT");

	waitUntil {sleep 1;WARCOM_blufor_ap>160};          
	WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "BLU_F" >> "Mechanized" >> "BUS_MechInf_AA");

	waitUntil {sleep 1;WARCOM_blufor_ap>210};          
	WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "BLU_F" >> "Mechanized" >> "BUS_MechInf_Support");

	waitUntil {sleep 1;WARCOM_blufor_ap>260};          
	WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "BLU_F" >> "Armored" >> "BUS_TankSection");

	waitUntil {sleep 1;WARCOM_blufor_ap>310};          
	WARCOM_blu_patrol_type = (configfile >> "CfgGroups" >> "West" >> "BLU_F" >> "Armored" >> "BUS_TankPlatoon_AA");
...
[] spawn {
          ...
          while {Warcom_Limiter_Param == 1} do {
			  ...
			  _opf_assault = [_group] execVM "WARCOM\WARCOM_wp_blu_patrol.sqf"; 
				...
				sleep (600 + (random 600)); // 10-20min was 900/900
		};
};
