...
[] spawn {
	...
	waitUntil {sleep 1;WARCOM_opfor_ap>=15};
	[West,"HQ"] sidechat "This is HQ, OPFOR troops are attacking, prepare some defenses!";
	...
	waitUntil {sleep 1;WARCOM_opfor_ap>90};
	WARCOM_opf_attack_wave_type = (configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "Mechanized" >> "OIA_MechInfSquad");

	waitUntil {sleep 1;WARCOM_opfor_ap>140};
	WARCOM_opf_attack_wave_type = (configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "Mechanized" >> "OIA_MechInf_AT");

	waitUntil {sleep 1;WARCOM_opfor_ap>190};
	WARCOM_opf_attack_wave_type = (configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "Mechanized" >> "OIA_MechInf_AA");

	waitUntil {sleep 1;WARCOM_opfor_ap>240};
	WARCOM_opf_attack_wave_type = (configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "Armored" >> "OIA_TankSection");

	waitUntil {sleep 1;WARCOM_opfor_ap>290};
	WARCOM_opf_attack_wave_type = (configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "Armored" >> "OIA_TankPlatoon_AA");
...
[] spawn {
          ...
          sleep (WARCOM_opf_attack_delay + (random 600)); // was 900
